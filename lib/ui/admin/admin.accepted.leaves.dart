...
class AdminAcceptedLeavesScreen extends StatelessWidget {
  const AdminAcceptedLeavesScreen({super.key});
          ...
          children: [
            ...
            Column(children: [
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseService.getAllAcceptedLeaves(),
                    ...
                    return Column(
                      children: [
                        ...
                        Container(
                          ...
                          child: MyTextWidget(
                            title:
                                "Total Accepted Leaves: ${snapshot.data!.docs.length}",
                            fontSize: 17,
